...
def get_organ_system_sort(H: np.ndarray, cancer_types: list, sample_ids: list, config_path: str) -> np.ndarray:
...
def get_sample_order(sort_method: str, H: np.ndarray, sample_ids: list, 
    ...
    print(f"Warning: Sort method '{sort_method}' not recognized. Defaulting to component sort.")
    return bar_sort_order(H_ord)